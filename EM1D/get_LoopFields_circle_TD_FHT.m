function dBzdt = get_LoopFields_circle_TD_FHT(times,rTxLoop,zTx,rRx,zRx,sig,mu,z,...
...
%
  ...
  BzFD = get_LoopFields_circle_FD_FHT(freqs,rTxLoop,zTx,rRx,zRx,sig,mu,z,HankelFilterName);

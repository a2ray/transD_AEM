...
tic
BzLM = get_LoopFields_TD_FHT(tLM,xyPolyTx,zTx,xyRx,zRxLM,sig,mu,z, HankelFilterName,CosSinFilterName,nFreqsPerDecade,LoopQuadOrder,rampLM,lowPassFiltersLM,nSplinePointsPerDecade);    
toc                     
...
tic
BzHM = get_LoopFields_TD_FHT(tHM,xyPolyTx,zTx,xyRx,zRxHM,sig,mu,z, HankelFilterName,CosSinFilterName,nFreqsPerDecade,LoopQuadOrder,rampHM,lowPassFiltersHM,nSplinePointsPerDecade);    
toc     
